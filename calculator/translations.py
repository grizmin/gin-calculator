...
INGREDIENT_NAMES_BG = {
    "Acacia flowers": "Акациеви цветове",
    "Almond": "Бадем",
    "Almonds": "Бадеми",
    "Ambrette seed": "Семе от амбрета",
    "Angelica root": "Корен от ангелика",
    "Angelica seeds": "Семена от ангелика",
    "Anise seed": "Семе от анасон",
    "Bee balm": "Пчелен балсам",
    "Bitter orange peel": "Кора от горчив портокал",
    "Black pepper": "Черен пипер",
    "Blackberry leaves": "Листа от къпина",
    "Camomile": "Лайка",
    "Caraway seeds": "Семена от ким",
    "Cardamom": "Кардамон",
    "Cassia bark": "Кора от касия",
    "Chamomile": "Лайка",
    "Cinnamon": "Канела",
    "Cloves": "Карамфил",
    "Coriander seeds": "Семена от кориандър",
    "Cranberry": "Червена боровинка",
    "Cubeb pepper": "Кубейски пипер",
    "Cucumber": "Краставица",
    "Cucumber essence": "Есенция от краставица",
    "Dog rose hips": "Шипки",
    "Elderflower": "Цвят от бъз",
    "Ginger": "Джинджифил",
    "Grains of paradise": "Райски зърна",
    "Hawthorn berries": "Плодове от глог",
    "Honeysuckle": "Орлови нокти",
    "Indian sarsaparilla": "Индийска сарсапарила",
    "Jasmine": "Жасмин",
    "Juniper berries": "Хвойна",
    "Juniper Berries": "Хвойна",
    "Lavender": "Лавандула",
    "Lemon balm": "Маточина",
    "Lemon peel": "Лимонова кора",
    "Lemon Peel": "Лимонова кора",
    "Lemon verbena": "Лимонова върбинка",
    "Lemongrass": "Лимонова трева",
    "Lingonberries": "Червени боровинки",
    "Liquorice root": "Корен от женско биле",
    "Makrut lime leaves": "Листа от кафирски лайм",
    "Marshmallow root": "Корен от бял оман",
    "Nutmeg": "Индийско орехче",
    "Orange peel": "Портокалова кора",
    "Orange peel (bitter)": "Кора от горчив портокал",
    "Orris root": "Корен от ирис",
    "Peppercorns": "Зърна черен пипер",
    "Pimento": "Бахар",
    "Pomelo peel": "Кора от помело",
    "Rose essence": "Есенция от роза",
    "Rose hip": "Шипка",
    "Rose mallow": "Розова ружа",
    "Sage": "Градински чай",
    "Seville orange peel": "Кора от севилски портокал",
    "Sloe berries": "Трънки",
    "Spruce shoots": "Смърчови филизи",
    "Sweet flag (calamus)": "Блатен аир",
    "Sweet orange peel": "Кора от сладък портокал",
    "Vanilla": "Ванилия",
    "Yarrow": "Бял равнец",
}